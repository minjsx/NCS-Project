...
<br/><br/><br/><br/>
<div class="div_left">
	<h1 class="bigName"><span style="margin-left:300px">ADDBRIDGE</span></h1><br/><br/><br/>
	<p><span style="margin-left:300px"><i class="fas fa-phone-volume"></i> &nbsp; 042-630-4949</span></p><br/>
	<p><span style="margin-left:297px"><i class="far fa-envelope"></i>  &nbsp; help@addbridge.com </span></p><br/>
	<p><span style="margin-left:300px"><i class="fas fa-map-marker-alt"></i>  &nbsp; 대전광역시 동구 백룡로 11번길 63 </span></p><br/>
	<p><span style="margin-left:322px"> (우송 IT 센터)1층 </span></p><br/>
	<p><span style="margin-left:300px"><i class="far fa-building"></i> &nbsp; 182-43-00974 </span></p><br/>
</div>
...
<div class="hr" style="display: table; width: 70%; margin: 0 auto 30px;"><hr></div>
<div class="bar-right">
