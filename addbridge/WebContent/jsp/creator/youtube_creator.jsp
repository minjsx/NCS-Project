...
<link href="<%= request.getContextPath() %>/css/youtube_creator_content.css" rel="stylesheet" type="text/css"/>
</head>
<body>
	<div class="container">
		<div class="header">
		<jsp:include page="youtube_creator_topbar.jsp"/>
		</div>
		<div class="content">
			...
			<div class="center-content">
				<div style="margin-top : 60px"></div>
				 ...
				 <jsp:include page="youtube_creator_content.jsp"/>				
			</div>
