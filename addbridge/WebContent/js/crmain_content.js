	window.onload = function(){
	   // TODO : Classname 바꿔야함   
	   var comboArr = document.getElementById("js-combo-wrapper").getElementsByClassName("promotion-combo");
	   ...
	   var tagtext = "";
			   ...
			   // 동적 EVENT 추가
				...
				//this = select를 의미, select[select.selectedIndex]는 현재 선택된 속성을 반환함.				  
			      ...
			      var deleteButton = document.createElement("input");
				      ...
				      document.getElementById("txtarea").appendChild(tagButton);
		   ...
		   document.getElementById("searchbox-searchbtn").addEventListener("click", function(){
			   var appendstr = "";
			   var textareaInner = document.getElementById("txtarea");
			   ...
			   appendstr += "channel-" + document.getElementById("txtinput").value;
			   document.getElementById("txtinput").value = "";
			   document.getElementById("txtarea").innerHTML = "";
			   document.getElementById("search-hidden-value").value = appendstr;
			   document.getElementById("promo-search-form").submit();
		   });
